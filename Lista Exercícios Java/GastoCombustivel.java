// 3) Efetuar o cálculo da quantidade de litros de combustível gasta em uma viagem, utilizando um automóvel que faz 12 Km por litro. 
// Para obter o cálculo, o usuário deve fornecer o tempo gasto na viagem e a velocidade média. Desta forma, será 
...
public class GastoCombustivel {
    public static void main(String[] args) {
        ...
        // solicitar dados ao usuário: tempo gasto em hrs, velocidade média, calcular distancia
